...
out.splogit.02<- link.compare.n5(model = 'splogit',s0=0,ns = ns0,muv=-0.5,nrep = nrep0,model.args = list(r=0.2),init.args = list(init = c(0.1,0.2),xi0=1,nu0=2,r0=1,intervalr=c(0.03,10),interval.nu=c(0.1,10)),lamv=10^(seq(-5,10,length.out = 50)),weights.arg=c('equal','both','left','right'))


out.splogit.5<- link.compare.n5(model = 'splogit',s0=0,ns = ns0,muv=-0.5,nrep = nrep0,model.args = list(r=5),init.args = list(init = c(0.1,0.2),xi0=-0.5,nu0=2,r0=1,intervalr=c(0.03,10),interval.nu=c(0.2,10)),bound=3,lamv=10^(seq(-5,10,length.out = 50)),weights.arg=c('equal','both','left','right'))


save(out.logit,out.probit,out.robit3,out.robit1,out.robit2,out.gev1,out.gev2,out.gev3,out.gev4,out.splogit.02,out.splogit.5,file='output/new/output500_nonlinear_case2.RData')
...
out.probit<- link.compare.n5(model = 'probit',ns = ns0,s0=0,nrep = nrep0,muv =-0.5,init.args = list(init = c(0,0.1),xi0=1,nu0=2,r0=1,intervalr=c(0.03,10),interval.nu=c(0.2,10)),bound=3,lamv=10^(seq(-5,10,length.out = 50)),weights.arg=c('equal','both','left','right'),case=3)
...
out.gev1 <- link.compare.n5(model = 'gev',ns = ns0,s0=0,nrep = nrep0,muv=-0.5,model.args = list(xi=1,locv=-1.5),init.args = list(init = c(0,0),xi0=0.6,nu0=2,r0=1,intervalr=c(0.03,10),interval.nu=c(0.2,10)),lamv=10^(seq(-5,10,length.out = 50)),weights.arg=c('equal','both','left','right'),case=3)
...
out.gev3 <- link.compare.n5(model = 'gev',ns = ns0,nrep = nrep0,muv=-0.5,model.args = list(xi=-0.5,locv=-0.5),init.args = list(init = c(0,0),xi0=-0.5,nu0=2,r0=1,intervalr=c(0.03,10),interval.nu=c(0.2,10)),lamv=10^(seq(-5,10,length.out = 50)),weights.arg=c('equal','both','left','right'),case=3)

out.gev4 <- link.compare.n5(model = 'gev',ns = ns0,s0 = 0,muv=-0.5,nrep = nrep0,model.args = list(xi=-1,locv=0.5),init.args = list(init = c(0,0.2),xi0=-0.5,nu0=1,r0=1,intervalr=c(0.03,10),interval.nu=c(0.2,10)),spline.control = list(deg = 3,nknots = 11),lamv=10^(seq(-5,10,length.out = 50)),weights.arg=c('equal','both','left','right'),case=3)

out.splogit.02<- link.compare.n5(model = 'splogit',s0=0,ns = ns0,muv=-0.5,nrep = nrep0,model.args = list(r=0.2),init.args = list(init = c(0.1,0.2),xi0=1,nu0=2,r0=1,intervalr=c(0.03,10),interval.nu=c(0.2,10)),lamv=10^(seq(-5,10,length.out = 50)),weights.arg=c('equal','both','left','right'),case=3)


out.splogit.2<- link.compare.n5(model = 'splogit',s0=0,ns = ns0,muv=-0.5,nrep = nrep0,model.args = list(r=2),init.args = list(init = c(0,0),xi0=-0.5,nu0=2,r0=1,intervalr=c(0.03,10),interval.nu=c(0.2,10)),bound=3,lamv=10^(seq(-5,10,length.out = 50)),weights.arg=c('equal','both','left','right'),case=3)
