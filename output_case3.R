...
pathn1_case3 <- 'output/output100_nonlinear_case3.RData' 
pathn2_case3 <- 'output/output200_nonlinear_case3.RData' 
pathn3_case3 <- 'output/output500_nonlinear_case3.RData'
