...
mse.out <-  cbind(out.logit$mse.mat,out.probit$mse.mat,out.robit1$mse.mat,out.robit2$mse.mat, out.gev1$mse.mat,out.gev2$mse.mat,out.splogit.05$mse.mat, out.splogit.5$mse.mat)
max.out <- cbind(out.logit$max.mat,out.probit$max.mat,out.robit1$max.mat,out.robit2$max.mat, out.gev1$max.mat,out.gev2$max.mat,out.splogit.05$max.mat, out.splogit.5$max.mat)
p.out <- cbind(out.logit$pmat,out.probit$pmat,out.robit1$pmat,out.robit2$pmat, out.gev1$pmat,out.gev2$pmat,out.splogit.05$pmat, out.splogit.5$pmat)
gr1.out <- cbind(out.logit$gr1,out.probit$gr1,out.robit1$gr1,out.robit2$gr1, out.gev1$gr1,out.gev2$gr1,out.splogit.05$gr1, out.splogit.5$gr1)
